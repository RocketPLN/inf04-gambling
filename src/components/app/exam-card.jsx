...
import { Card, CardStripe, CardHeader, CardTitle, CardDescription, CardFooter } from "@/components/ui/card";
import { FungusWhisper } from "@/components/app/fungus";
import { cn } from "@/lib/utils";

const TILTS = ["odd", "even", "alt"];

export function ExamCard({ exam, index, color, search }) {
