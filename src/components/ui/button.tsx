...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-1.5 border-4 font-bold uppercase tracking-wider cursor-pointer no-underline shadow-[4px_4px_0_#000] transition-none select-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
